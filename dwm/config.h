...
static const char *ranger[]      = { "uxterm", "-e", "cat /home/hmps/.cache/wal/sequences;ranger", NULL };
static const char *email[]       = { "uxterm", "-e", "cat /home/hmps/.cache/wal/sequences;neomutt", NULL };
