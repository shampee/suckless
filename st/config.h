...
/* --------------- Font ---------------------------------- */
char font[] = "SFMono:pixelsize=13:antialias=true:autohint=true";
...
// just isn't good.
void plumb() {
  system("/bin/dash ${HOME}/usr/bin/plumb 2>> /tmp/plumb_errors.txt &");
}
/* void execute() { system("/bin/dash ${HOME}/bin/execute.sh 2>>
 * /tmp/execute_errors.txt &"); } */
